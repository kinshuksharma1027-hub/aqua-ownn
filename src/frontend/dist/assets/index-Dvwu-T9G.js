const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/__root-CDovOn6g.js","assets/useScrollPosition-DDE3F8aK.js","assets/createLucideIcon-bMRtb0YX.js"])))=>i.map(i=>d[i]);
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./HomePage-DISZTaml.js"), true ? [] : void 0));
const RootLayout = reactExports.lazy(() => __vitePreload(() => import("./__root-CDovOn6g.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
...
const queryClient$1 = new QueryClient({
  defaultOptions: {
    queries: { staleTime: 5 * 60 * 1e3, retry: 1 }
  }
});
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen gradient-hero flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full border-4 border-primary border-t-transparent animate-spin" }) }),
